...
const Lorem = () => {
        return ( <div className="container"> 
                ...
                <div className="title">
                        ...
                        <p className="Nutrition"> Nutrition fact</p>
                </div>
                        <div className="subtitle">
                                <p className="Serving "> Serving Size <span className="content-right">100g </span>   </p>
                                <hr className="lines"/> 
                                <p className="Amount"> Amount per serving </p>
                                
                        </div>
                        <div >
                        <p className="Calories"> Calories <span className="content-right"> 89</span> </p>
                        <hr  className="lines"/>
                        <div className="content-right-11">  %Daily value* </div>
